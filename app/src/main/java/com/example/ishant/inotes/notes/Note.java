 ...
 * 
 */
package com.example.ishant.inotes.notes;
...
import com.example.ishant.inotes.note_list.LinkListDialog;
...
public class Note
{
	...
	public void popupHyperlinks(final ActionBarActivity activity)
	{
		...
		dialog.setLinkListener(new LinkListDialog.LinkListener()
		{
